...
$query= mysql_query("SELECT title,description,keywords, text from dnepropetrovsk where page_id='memorial_pogibshim_milicioneram'", $db);
if (! $query){exit('Error');}
...
<div id="stripe"></div>
	<div id="middle">
		...
		<div id="container">
			...
			<div id="content">
           <?php require_once("js/memorial_pogibshim_milicioneram.js") ;?>
